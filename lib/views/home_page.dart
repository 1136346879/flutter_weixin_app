...
import 'package:flutter_weixin_app/model/conversation.dart'
    show
        ...
        Manager;
import 'package:flutter_weixin_app/utils/net_utils.dart';
import 'package:flutter_weixin_app/components/PullLoadWidget.dart';
import 'package:flutter_weixin_app/components/ListState.dart';
...
import 'package:flutter_weixin_app/views/home_chat_page.dart';
import 'dart:math';
///微信--首页
...
class _HomePageState extends State<HomePage>
  ...
  Future<Null> onLoadMore() async {
    ...
    setState(() {
      // 10次加载数据
      pullLoadWidgetControl.needLoadMore =
          (mockConversation != null && mockConversation.length < 105);
    });
    isLoading = false;
    return null;
  }
